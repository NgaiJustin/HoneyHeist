...
import edu.cornell.gdiac.honeyHeistCode.obstacle.WheelObstacle;
...
public class BallModel extends WheelObstacle {
    ...
    /** Returns left/right movement of the ball */
    public float getMovement() {
        return movement;
    }

    /** Sets left/right movement of the ball */
    ...
    /** Returns if the ball is on the ground. */
    public boolean isGrounded() {
        return isGrounded;
    }

    /** Returns if the ball is in honey. */
    public boolean isInHoney() {
        return isInHoney;
    }

    /** Sets whether the ball is on the ground. */
    public void setGrounded(boolean value) {
        isGrounded = value;
    }

    /** Sets whether the ball is in honey. */
    ...
    /** Remove all forces on ball - Halts movement */
    ...
    public void draw(GameCanvas canvas) {
        canvas.draw(texture, Color.WHITE, origin.x, origin.y,
                getX() * drawScale.x,
                getY() * drawScale.y,
                getAngle(), drawScale.x/texture.getRegionWidth(), drawScale.y/texture.getRegionHeight());
    }
